...
def piyaz(x):
    s = len(degisken.get())
    if (s <= 20):
        if (ekran.get() != "3.141592" and ekran.get() != "2.718281" and ekran.get() != "3.141592+3.141592" and ekran.get() != "3.141592**3.141592" and degisken.get() != "2.718281**2.718281" and degisken.get() != "2.718281**3.141592" and degisken.get() != "3.141592**2.718281"):
            ekran.insert(s, str(x))
